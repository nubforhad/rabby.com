...
@section('title', 'Live TV Details')
@section('page-title', 'Live TV Details')
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        View live TV channel information
                    </p>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-gray-500">
                            {{ $liveTv->sub_title ?: 'No subtitle available' }}
                        </p>
            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                        ...
                        <p class="mt-1 text-sm font-semibold text-gray-800">
                            {{ $liveTv->created_at?->format('d M Y, h:i A') }}
                        </p>
                    ...
                    <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                        ...
                        <p class="mt-1 text-sm font-semibold text-gray-800">
                            {{ $liveTv->updated_at?->format('d M Y, h:i A') }}
                        </p>
